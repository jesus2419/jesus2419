...
[![pub.dev](https://img.shields.io/badge/pub.dev-Packages-0175C2?style=for-the-badge&logo=dart&logoColor=white)](https://pub.dev/packages/eli_ble_gatt_server)
</div>
...
|---------|-------------|-------|
| **eli_ble_gatt_server** | Flutter plugin that turns a device into a BLE GATT Server (peripheral) with custom UUIDs and READ/WRITE/NOTIFY support — Android & iOS. | [![pub](https://img.shields.io/pub/v/eli_ble_gatt_server?logo=dart&color=0175C2)](https://pub.dev/packages/eli_ble_gatt_server) · [![GitHub](https://img.shields.io/badge/Code-181717?logo=github)](https://github.com/jesus2419/eli_ble_gatt_server) |
| **abi_beacon** | Android Flutter plugin for iBeacon background monitoring that survives OEM battery restrictions via a persistent foreground service. | [![pub](https://img.shields.io/pub/v/abi_beacon?logo=dart&color=0175C2)](https://pub.dev/packages/abi_beacon) · [![GitHub](https://img.shields.io/badge/Code-181717?logo=github)](https://github.com/jesus2419/Abi-Beacon) |
